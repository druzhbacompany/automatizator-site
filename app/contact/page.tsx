...
export const metadata: Metadata = {
  title: 'Консультации по автоматизации: разбор ситуации без навязывания',
  description:
    'Запишитесь на консультацию по автоматизации. Разберём вашу систему ботов, интеграций и запусков, покажем слабые места и честно предложим следующий шаг — без навязывания сложных пакетов.',
  openGraph: {
    title: 'Консультации по автоматизации и интеграциям',
    description:
      'Если запуски трещат по швам или страшно трогать текущие интеграции — приходите на консультацию. Спокойно разбираем ситуацию и находим адекватный объём работ.',
    url: '/contact',
    type: 'website'
  }
};
